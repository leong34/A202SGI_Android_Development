...
public class HomeFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater inflater) {
        inflater.inflate(R.menu.search_poll, menu);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    if(!snapshot.child("creatorUID").getValue(String.class).equals(sharedPreferences.getString("uid", null)) && snapshot.child("status").getValue(String.class).equals("Available") && snapshot.child("public").getValue(Boolean.class)){
                ...
                if (getActivity()!=null){
                    RecycleViewPollAdapter pollAdapter = new RecycleViewPollAdapter(getActivity(), pollList, false);
